...
var TxBuilder = /** @class */ (function () {
    ...
    TxBuilder.prototype.setSettingValue = function (params) {
        return new TxBuilder(txHelper_1["default"].addCommand(this.tx, 'setSettingValue', validation_1["default"](params, ['key', 'value'])));
    };
